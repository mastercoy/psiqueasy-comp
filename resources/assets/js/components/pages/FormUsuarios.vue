                ...
                <div class="table-responsive">
                    <table class="table table-sm">
                        ...
                        <tr v-for="user in users" :key="user.id">
                            ...
                            <td>
                                <router-link :to="{name:'EditUsuario', params: {user} }" class="btn btn-sm btn-warning"><i class="fa fa-pencil-square" aria-hidden="true"></i></router-link>
                            </td>
                            <td><a @click="selectUser = user.name" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#exampleModalCenter"><i class="fa fa-trash"
