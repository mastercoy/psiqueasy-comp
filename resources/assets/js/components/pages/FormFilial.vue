            ...
            <div class="table-responsive">
                <table class="table table-sm">
                    ...
                    <tr v-for="filial in filiais" :key="filial.id">
                        ...
                        <td> {{ filial.name }}</td>
                        <td>
                            <router-link :to="{name:'EditFilial', params: {filial} }" class="btn btn-warning btn-sm"><i class="fa fa-pencil-square" aria-hidden="true"></i></router-link>
                        </td>
                        <td><a @click="selectFilial = filial" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#exampleModalCenter"><i class="fa fa-trash" aria-hidden="true"></i></a>
                        </td>
                    </tr>
                    </tbody>
                </table>
